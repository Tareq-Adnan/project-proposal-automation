...
$pdfFiles = ['cover.pdf','pre_pages.pdf', 'output.pdf','terms.pdf','post_pages.pdf']; // Adjust the file names accordingly
        ...
        foreach ($nonEmptyRows as $key => $row) {
           // $data .= "<tr>";
            foreach ($nonEmptyColumns as $colkey=> $col) {
                ...
                if($cellValue){
                    if($cellValue=="Payment Terms" || $cellValue== "Terms & Conditions") continue;
                    // if(($key==0 && $colkey== 0) || ($key==3 && $colkey==0)) continue;
                    if($key==1) $data.="<li><b>Payment Method</b>"."<ul><li>".$cellValue.$key."</li></ul></li>";
                    else if($key==2) $data.="<li><b>(VAT & TAX)</b>"."<ul><li>".$cellValue."</li></ul></li></ul><h2  class='title'>5. Terms & Conditions</h2><ul>";
                    else if($key==5) $data.="<li><b>Non-Disclosure Understanding</b>"."<ul><li>".$cellValue."</li></ul></li>";
                    else if($key==6) $data.="<li><b>Offer Validity</b>"."<ul><li>".$cellValue."</li></ul></li>";
                    else $data.="<li>".$cellValue."</li></li>";
                }
